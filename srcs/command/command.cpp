...
{
	{
		this->_errMess[ERR_NOSUCHNICK] = _client->getNickname() + " :No such nick/channel";
		this->_errMess[ERR_NOSUCHSERVER] = _serverRef->getName() + " :No such server";
		...
		this->_errMess[ERR_WASNOSUCHNICK] = _client->getNickname() + " :There was no such nickname";
		...
		this->_errMess[ERR_ERRONEUSNICKNAME] = "_client->getNickname() + :Erroneous nickname";
		this->_errMess[ERR_NICKNAMEINUSE] = _client->getNickname() + " :Nickname is already in use";
		this->_errMess[ERR_NICKCOLLISION] = _client->getNickname() + " :Nickname collision KILL from <user>@<host>";
		this->_errMess[ERR_UNAVAILRESOURCE] = "<nick/channel> :Nick/channel is temporarily unavailable";
		this->_errMess[ERR_USERNOTINCHANNEL] = "_client->getNickname() + <channel> :They aren't on that channel";
		...
		// this->_errMess[RPL_ISON] = ":*1" + _client->getNickname() +" *( \" \" " + _client->getNickname() + " )";
		// this->_errMess[RPL_AWAY] = _client->getNickname() + " :<away message>";
		...
		// this->_errMess[RPL_WHOISUSER] = _client->getNickname() + " <user> <host> * :<real name>";
		// this->_errMess[RPL_WHOISSERVER] = _client->getNickname() + " <server> :<server info>";
		// this->_errMess[RPL_WHOISOPERATOR] = _client->getNickname() + " :is an IRC operator";
		// this->_errMess[RPL_WHOISIDLE] = _client->getNickname() + " <integer> :seconds idle";
		// this->_errMess[RPL_ENDOFWHOIS] = _client->getNickname() + " :End of WHOIS list";
		// this->_errMess[RPL_WHOISCHANNELS] = _client->getNickname() + " :*( ( \" @\" / \" \" ) <channel> \" \" )";
		// this->_errMess[RPL_WHOWASUSER] = _client->getNickname() + " <user> <host> * :<real name>";
		// this->_errMess[RPL_ENDOFWHOWAS] = _client->getNickname() + " :End of WHOWAS";
		// this->_errMess[RPL_LIST] = "<channel> <# visible> :<topic>";
		// this->_errMess[RPL_LISTEND] = ":End of LIST";
		// this->_errMess[RPL_UNIQOPIS] = "<channel> " + _client->getNickname();
		...
		// this->_errMess[RPL_INVITING] = "<channel> " + _client->getNickname();
		...
		// this->_errMess[RPL_WHOREPLY] = "<channel> <user> <host> <server> " + _client->getNickname();
		...
		// this->_errMess[RPL_TRACEOPERATOR] = "Oper <class> " + _client->getNickname();
		// this->_errMess[RPL_TRACEUSER] = "User <class> " + _client->getNickname();
